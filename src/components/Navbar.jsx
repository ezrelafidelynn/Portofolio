    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-black border-b border-gray-800">
      <div className="max-w-4xl mx-auto px-4 py-2.5">
        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-instagram cursor-pointer" onClick={() => scrollToSection('home')}>
            Ezrela
          </h1>
          ...
          <div className="hidden md:flex items-center space-x-6">
            ...
            <button className="hover:text-gray-400 transition-colors">
              <div className="w-6 h-6 rounded-full bg-gradient-to-br from-purple-600 to-pink-500 border-2 border-white"></div>
            </button>
          </div>
      ...
      <div className="md:hidden fixed bottom-0 left-0 right-0 bg-black border-t border-gray-800 z-50">
        <div className="flex justify-around py-2">
          <button onClick={() => scrollToSection('home')} className="p-2">
          ...
          <button className="p-2">
            <div className="w-6 h-6 rounded-full bg-gradient-to-br from-purple-600 to-pink-500 border border-white"></div>
          </button>
        </div>
      </div>
    </nav>
